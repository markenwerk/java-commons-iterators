...
This library provides the [`NodeListIterator`][NodeListIterator] that takes and existing [`NodeList`][NodeList] and yields every [`Node`][Node] yielded by the given [`NodeList`][NodeList].
